...
export default function AirdropPages() {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <div className="rounded-xl overflow-hidden shadow-md mt-5  min-h-[400px]">
        <table cellPadding="15" className="w-full bg-white h-64">
        ...
        <div className="flex justify-center mt-6 space-x-2">
          {Array.from({ length: totalPages }, (_, i) => (
            <button
              ...
              className={`w-10 h-10 text-sm border rounded-full transition duration-200
        ${
          currentPage === i + 1
