...
export default function CreateAirdropPage() {
  ...
  return (
    <div className="w-full add-form rounded-xl p-8">
      <h1 className="font-bold text-lg relative top-2">Thêm Airdrop</h1>
      <form
        onSubmit={handleCreate}
        className="grid grid-cols-2 gap-6 w-[100%] mx-auto bg-white p-7 rounded-xl shadow-md"
      >
        {/* Input 1 */}
        ...
        {/* Input 5 */}
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium">Total Token</label>
          <input
            type="number"
