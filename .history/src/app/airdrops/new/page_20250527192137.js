    ...
    <div className="w-full add-form rounded-xl p-8">
      ...
      <form onSubmit={handleCreate} className="form">
        <div className="form-left flex flex-col justify-between ">
          ...
          <div className="flex justify-between h-16 outline-1  items-center">
            <span className="text-sm"> name: </span>
      ...
      <button
        type="submit"
        className="text-xs pl-8 pr-8 pt-2 pb-2 text-blue-500 bg-blue-100 border border-blue-300 rounded-lg"
      >
        Tạo
      </button>
    </div>
